<h2><a href="https://practice.geeksforgeeks.org/problems/merge-k-sorted-arrays/1?category[]=Shortest+Path&category[]=Shortest+Path&page=1&query=category[]Shortest+Pathpage1category[]Shortest+Path">Merge k Sorted Arrays</a></h2><h3>Difficulty Level : Medium</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given <strong>K</strong> sorted arrays arranged in the form of a matrix of size K*K. The task is to merge them into one sorted array.<br>
